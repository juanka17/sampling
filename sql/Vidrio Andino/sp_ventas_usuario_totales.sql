drop procedure if exists sp_ventas_usuario_totales;

DELIMITER //

create procedure sp_ventas_usuario_totales(id_usuario_p int, lija_seca_p int)
begin
...
call sp_ventas_usuario_totales(49,0);