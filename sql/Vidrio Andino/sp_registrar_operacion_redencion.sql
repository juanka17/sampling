drop procedure if exists sp_registrar_operacion_redencion;

DELIMITER //

create procedure sp_registrar_operacion_redencion(id_redencion_p int, id_operacion_p int, comentario_p varchar(50), referencia_p varchar(50), id_registra_p int)
begin
